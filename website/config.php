...
<head>
  ...
  <!-- CSS propio -->
  <link rel = "stylesheet" href = "http://pepemanboy.com/plcmonitor/css/plcshield.css">
  <!-- Titulo de pagina --> 
  ...
  <div class = "container admin">
    ...
    <form>
      ...
      for ($i = 1; $i <= 6; $i++) {
        ...
        <!-- Gain-->
        <input type="number" class="form-control" placeholder = "Input gain" id = "gain-ai' . $i . '"> 
        <!-- Label offset -->
        <div class="input-group-prepend">
        <span class="input-group-text" id="">Offset:</span>
        </div>
        <!-- Offset-->
        <input type="number" class="form-control input-group-append" placeholder = "Input offset" id = "offs-ai' . $i . '">             
        </div>
        </div>          
      ...
      for ($i = 1; $i <= 6; $i++) {
        ...
        <!-- Nombre -->
        <input type="text" class="form-control" placeholder = "Nombre" id = "name-do' . $i . '">
        </div>
        </div>          
        <!-- Acaba salida -->
        ';
